...
# Single GPU
accelerate launch \
--config_file ~/PycharmProjects/alignment-handbook/recipes/accelerate_configs/fsdp_qlora.yaml \
--num_processes=2 \
~/PycharmProjects/alignment-handbook/scripts/run_sft_zephyr.py \
~/PycharmProjects/alignment-handbook/recipes/zephyr-7b-beta/sft/config_qlora.yaml \
